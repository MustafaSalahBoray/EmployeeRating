				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<div class="btn-group">
								<a href="javascript:void(0)" data-id='' class="btn btn-primary btn-flat manage_designation">
									<i class="fas fa-edit"></i>
								</a>
								<button type="button" class="btn btn-danger btn-flat delete_designation" data-id="">
